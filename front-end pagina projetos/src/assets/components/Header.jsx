...
import { BsFillPuzzleFill, BsMegaphoneFill, BsPencilSquare } from 'react-icons/bs';
...
export function Header() {
  ...
  return (
    <header className={`${styles.header} d-flex align-items-center justify-content-between`}>
      ...
      <Nav.Item as="lu" className="ml-auto ml-2"> {/* Adicione ml-auto e ml-2 para empurrar 'Entrar' para a direita */}
